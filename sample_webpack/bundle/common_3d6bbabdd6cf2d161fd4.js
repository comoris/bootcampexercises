...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"a","1":"b"}[chunkId]||chunkId) + "._" + "3d6bbabdd6cf2d161fd4" + ".js";
	...
	var userService = function () {
	    ...
	    _createClass(userService, [{
	        ...
	        value: function getAll() {
	            console.log(moment().format());
	            return [{ id: '123', name: 'Bram' }, { id: '129', name: 'peter' }];
	        }
	    }, {
	        key: 'getOne',
...
/***/ }
/******/ ]);
//# sourceMappingURL=common_3d6bbabdd6cf2d161fd4.js.map